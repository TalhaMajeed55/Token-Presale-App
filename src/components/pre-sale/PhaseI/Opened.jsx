...
const Opened = () => {
  ...
  const actionButton = () => {
    ...
    return (
      <Button fullWidth onClick={() => execFunc()}>
        {label}
      </Button>
    );
  };
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            <CardContent>
              ...
              <Divider light textAlign="left" sx={{ mt: 3 }}>
                <Chip label="Pre-sale Information" />
              </Divider>
